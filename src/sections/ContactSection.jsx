  ...
  const contactDetails = [
    {
      icon: '📧',
      label: 'EMAIL',
      content: import.meta.env.VITE_EMAILJS_TO_EMAIL || 'shihabthebrowncrow@gmail.com'
    },
    {
      icon: '📍',
      label: 'LOCATION',
  ...
  const socialLinks = [
    {
      ...
      href: 'https://github.com/daCircuitSage'
    },
    {
      name: 'LinkedIn',
      icon: (
    ...
    },
    {
      ...
      href: `mailto:${import.meta.env.VITE_EMAILJS_TO_EMAIL || 'shihabthebrowncrow@gmail.com'}`
    },
    {
      name: 'Twitter/X',
      icon: (
